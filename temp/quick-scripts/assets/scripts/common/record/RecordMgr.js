(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/scripts/common/record/RecordMgr.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '2fbd48LbHxF9bxSlw1CzIGJ', 'RecordMgr', __filename);
// scripts/common/record/RecordMgr.js
...
cc.Class({
    ...
    tryToStopRecord: function tryToStopRecord(moveType) {
        if (cc.sys.isNative) {
    ...
    uploadVoice: function uploadVoice(deltaTime) {
        ...
        // customHttpRequest.setFile(cc.url.raw("resources/music/" + "please_cut_card.mp3"))
            ...
            if (customHttpRequest1) {
                ...
                //发送录音
                cc.netMgr.request("room_chat", { type: 4, words: ret.url }, function (ret) {}.bind(this));
            } else {
                cc.log(null, '网络错误');
            }
        }.bind(this));
    ...
    downloadVoice: function downloadVoice(url) {
    ...
    convertToAmr: function convertToAmr(fileName) {
    ...
    getCurRecordTime: function getCurRecordTime() {
    ...
    decodeFile: function decodeFile(filePath) {
        if (cc.sys.isNative) {
            if (cc.sys.os == cc.sys.OS_ANDROID) {
    ...
    getPlayableFilePath: function getPlayableFilePath(filePath) {
