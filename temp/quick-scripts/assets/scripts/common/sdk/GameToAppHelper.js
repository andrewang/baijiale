(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/scripts/common/sdk/GameToAppHelper.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '546d6d4j7hHUYqOMH0I4ca0', 'GameToAppHelper', __filename);
// scripts/common/sdk/GameToAppHelper.js
...
GameToAppHelper.weChatRoomInvite = function () {
    //邀请微信进入房间
...
GameToAppHelper.dingdingRoomInvite = function () {
    //丁丁邀请进入房间
    var data = GameToAppHelper.getShareRoomInfo();
    var paramStr = JSON.stringify(data);
    console.log(paramStr);
...
GameToAppHelper.shareGameToWeChatFriend = function () {
    //微信好友分享游戏
    var gameId = 1;
...
GameToAppHelper.shareGameToWeChatMoment = function () {
    //微信朋友圈分享游戏
    var gameId = 1;
    var param = { 'gameId': gameId };
    var paramStr = JSON.stringify(param);
...
GameToAppHelper.sharePicToWeChatMoment = function (imagePath) {
    //分享图片到微信朋友圈
...
GameToAppHelper.sharePicToDingdingMoment = function (imagePath) {
    //分享图片到丁丁朋友圈
    var roomId = gUserData.roomInfo.rid;
    var gameId = 1;
    var param = { 'roomId': roomId, 'gameId': gameId, 'shareImagePath': imagePath };
...
GameToAppHelper.sharePicToWeChatFriend = function (imagePath) {
    //分享图片到微信好友
    var roomId = gUserData.roomInfo.rid;
    var gameId = 1;
    var param = { 'roomId': roomId, 'gameId': gameId, 'shareImagePath': imagePath };
...
GameToAppHelper.sharePicToDingdingFriend = function (imagePath) {
    //分享图片到丁丁好友
    var roomId = gUserData.roomInfo.rid;
    var gameId = 1;
    var param = { 'roomId': roomId, 'gameId': gameId, 'shareImagePath': imagePath };
...
GameToAppHelper.getGameEnterInitData = function () {
    //获取游戏关键信息
    var data = null;
...
GameToAppHelper.shareCreateClubGame = function () {
    //创建群房间
    var data = GameToAppHelper.getShareRoomInfo();
...
GameToAppHelper.executeRecharge = function (itemData, payType, agentId) {
    //充值
...
cc._RF.pop();
        ...
        //# sourceMappingURL=GameToAppHelper.js.map
