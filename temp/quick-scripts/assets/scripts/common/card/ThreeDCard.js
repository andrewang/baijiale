(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/scripts/common/card/ThreeDCard.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '5fccdZxnMFGgrNXTptWf0Dx', 'ThreeDCard', __filename);
// scripts/common/card/ThreeDCard.js
...
cc.Class({
    ...
    createGlNode: function createGlNode() {
    ...
    createProgram: function createProgram(vsource, fsource) {
    ...
    drawByMoveProgram: function drawByMoveProgram(rotationLc) {
    ...
    drawBySmoothProgram: function drawBySmoothProgram(rotationLc) {
    ...
    drawByEndProgram: function drawByEndProgram() {
    ...
    drawArrays: function drawArrays(pos, tex) {
    ...
    initTexAndPos: function initTexAndPos(isBack) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=ThreeDCard.js.map
