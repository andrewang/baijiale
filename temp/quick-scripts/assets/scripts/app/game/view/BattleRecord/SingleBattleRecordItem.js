(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/scripts/app/game/view/BattleRecord/SingleBattleRecordItem.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'ead9fGTgc1Am5F3zFz8eFmk', 'SingleBattleRecordItem', __filename);
// scripts/app/game/view/BattleRecord/SingleBattleRecordItem.js
...
cc.Class({
    ...
    setData: function setData(data) {
        ...
        for (var _i in data.state_info.state_list) {
            if (data.state_info.state_list[_i] == 6) txtZhuangPoint.node.color = cc.Color.WHITE.fromHEX("#FFF799");
            if (data.state_info.state_list[_i] == 7) txtXianPoint.node.color = cc.Color.WHITE.fromHEX("#FFF799");
        }
        // for (var i = 1; i <= 3; i++) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=SingleBattleRecordItem.js.map
