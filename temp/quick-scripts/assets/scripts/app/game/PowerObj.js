(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/scripts/app/game/PowerObj.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'b3e68mAboBIT7AnkGRR5QHH', 'PowerObj', __filename);
// scripts/app/game/PowerObj.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        ...
        touchNode.on(cc.Node.EventType.TOUCH_MOVE, function (touch) {
            if ("node_quanxian_xian" == this.node._name && cc.gameMgr.jipaiXianUid == cc.gameMgr._myData.user_base_info.uid || "node_quanxian_zhuang" == this.node._name && cc.gameMgr.jipaiZhuangUid == cc.gameMgr._myData.user_base_info.uid) {
    ...
    handleMovePowerObj: function handleMovePowerObj() {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=PowerObj.js.map
