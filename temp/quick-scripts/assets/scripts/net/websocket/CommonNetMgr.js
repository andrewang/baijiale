(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/scripts/net/websocket/CommonNetMgr.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'e51f8ouASdCaKLlywWrwarY', 'CommonNetMgr', __filename);
// scripts/net/websocket/CommonNetMgr.js
...
cc.Class({
    ...
    initData: function initData() {//初始化常用数据
    ...
    reconnect: function reconnect(next) {
        ...
        this.showMsgBoxConnectCb = function () {
            cc.common.showMsgBox({
                type: 2, msg: "网络连接失败，请重试！", okCb: function okCb() {
    ...
    //停止发送心跳，不可外部调用
    stopHeatBeat: function stopHeatBeat() {
    ...
    //获取游戏服务器地址
    getGameServerIp: function getGameServerIp() {
        if (this.gate) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=CommonNetMgr.js.map
