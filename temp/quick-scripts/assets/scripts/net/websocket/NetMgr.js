(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/scripts/net/websocket/NetMgr.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '90f8fEdWzpJ54yZOpmF4zRE', 'NetMgr', __filename);
// scripts/net/websocket/NetMgr.js
...
cc.Class({
    ...
    setIsReconnnect: function setIsReconnnect(isReconnect) {
    ...
    close: function close(isReconnect) {
        if (!this._commonNetMgr) {
            cc.log("_commonNetMgr closed");
            return;
        }
    ...
    reconnect: function reconnect(next) {},

    //应用退到后台
    onAppBack: function onAppBack() {
        this.close(false);
    },

    //应用回到前台
    onAppFront: function onAppFront() {
    ...
    // 发送网络请求
    request: function request(name, msg, cb) {
        if (!this._commonNetMgr) {
            cc.log("_commonNetMgr closed");
            return;
        }
    ...
    setLoginCallBack: function setLoginCallBack(next) {
    ...
    initNetHandlers: function initNetHandlers(socket) {
        if (!socket) {
            // TODO:
            return;
        }
                ...
                if (2 == ret.type) {
                    ...
                    //在房主解散房间时，其他玩家的页面里应该弹出“房主已解散房间”的提示，点击“确定”后返回到游戏大厅
                            ...
                            cc.common.showMsgBox({
                                type: 2, msg: "房主已解散房间", okCb: function okCb() {
                                    cc.gameMgr.backToLobbyScene();
                                }
                            });
                        }
        ...
        socket.on("on_user_kick", function (ret) {
            this.pushData("on_user_kick", ret, function () {
                ...
                cc.common.showMsgBox({
                    type: 2, msg: "您的账号已在其它设备登录！", okCb: function okCb() {
                        //this.close(false)
    ...
    pushData: function pushData(name, ret, cb) {
